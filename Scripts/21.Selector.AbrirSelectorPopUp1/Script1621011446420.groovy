...
'Buscar la selector Popup'
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'Selector.Abrir')
...
'Cambiamos a 1= ventana emergente'
...
WebUI.click(findTestObject('Configuracion/Sistema/Parametros Generales/Cambiar Parametro Valor/li_1'), FailureHandling.STOP_ON_FAILURE)
...
'Para abrir el selector y generar un turno'
WebUI.callTestCase(findTestCase('0 Generar Turno Ventana Emergente'), [:], FailureHandling.STOP_ON_FAILURE)
