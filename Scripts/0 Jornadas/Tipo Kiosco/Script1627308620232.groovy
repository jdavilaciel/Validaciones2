...
'Tipo de Jornada'
WebUI.setText(findTestObject('Configuracion/Jornadas de Atencion/2Lista de Jornadas/input_TextoABuscar'), 'Kiosco')
...
'Tipo de Jornada'
WebUI.selectOptionByLabel(findTestObject('Configuracion/Jornadas de Atencion/2Edicion/select_Tipo'), 'Kiosco', false)
...
WebUI.verifyElementVisible(findTestObject('Configuracion/Elementos del Sistema/Kioscos/3JornadasOficinas/td_Kiosco'))
