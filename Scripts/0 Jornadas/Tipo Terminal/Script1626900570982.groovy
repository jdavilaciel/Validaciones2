...
'Tipo de Jornada'
WebUI.setText(findTestObject('Configuracion/Jornadas de Atencion/2Lista de Jornadas/input_TextoABuscar'), 'Terminal')
...
'Tipo de Jornada'
WebUI.selectOptionByLabel(findTestObject('Configuracion/Jornadas de Atencion/2Edicion/select_Tipo'), 'Terminal', false)
...
WebUI.verifyElementVisible(findTestObject('Configuracion/Elementos del Sistema/Terminales/3JornadasPorOficina/span_Terminal'))
...
WebUI.verifyElementVisible(findTestObject('Configuracion/Elementos del Sistema/Selectores/2Jornada por Oficina/span_Selector'))
