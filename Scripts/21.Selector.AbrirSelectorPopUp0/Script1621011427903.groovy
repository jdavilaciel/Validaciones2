...
WebUI.click(findTestObject('Configuracion/Sistema/Parametros Generales/Cambiar Parametro Valor/li_0'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('0 Generar Turno PopUp'), [:], FailureHandling.STOP_ON_FAILURE)
