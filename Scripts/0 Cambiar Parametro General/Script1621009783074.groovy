...
'Buscar la terminal Popup'
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'Terminal.AbrirTerminalPopUp')
...
'Cambiamos a 1= ventana emergente; 0=PopUp'
...
WebUI.sendKeys(findTestObject(null), '1')
