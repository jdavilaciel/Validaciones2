...
'Agregamos Motivos de Suspensión'
...
WebUI.verifyElementVisible(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/Funciones Basicas/img_Suspender'))

WebUI.click(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/Funciones Basicas/img_Suspender'))
