...
'Eliminamos Motivos de Cancelación de Turno'
...
WebUI.click(findTestObject('Configuracion/Distribucion Geografica/Oficinas/3Otras Configuraciones/3Motivos/img_Eliminar'))
...
'Se muestra que no está presente el botón de cancelar turno'
WebUI.takeFullPageScreenshot()
