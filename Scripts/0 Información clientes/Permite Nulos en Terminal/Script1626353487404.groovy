...
WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/9Permite Nulo/chk_3Lugar de expedicion'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/9Permite Nulo/chk_4Primer nombre'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/9Permite Nulo/chk_5Segundo nombre'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/9Permite Nulo/chk_6Primer apellido'))
...
WebUI.clearText(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/0Campos/0Cliente/input_3Lugar de expedicion'))

WebUI.clearText(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/0Campos/0Cliente/input_4Primer nombre'))

WebUI.clearText(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/0Campos/0Cliente/input_5Segundo nombre'))

WebUI.clearText(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/0Campos/0Cliente/input_6Primer apellido'))
