...
WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/5Editable en Terminal/chk_1Tipo Identificacion'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/5Editable en Terminal/chk_2Identificacion'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/5Editable en Terminal/chk_3Lugar de expedicion'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/5Editable en Terminal/chk_4Primer nombre'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/5Editable en Terminal/chk_5Segundo nombre'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/5Editable en Terminal/chk_6Primer apellido'))

WebUI.check(findTestObject('Configuracion/Datos Complementarios/Informacion Clientes/1 Parametros a mostrar del Cliente/Mostrar del Cliente/5Editable en Terminal/chk_7Segundo apellido'))
...
WebUI.setText(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/Cliente/input_Segundo apellido'), 'Zuazo')
