...
WebUI.selectOptionByLabel(findTestObject('Configuracion/Distribucion Geografica/Grupos/Edicion/select_NivelVisualizacinenReclasificacion'), 
    'Todos', false)
...
WebUI.click(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/Funciones Adicionales/img_Reclasificar'))
...
WebUI.selectOptionByIndex(findTestObject('Configuracion/Distribucion Geografica/Grupos/Edicion/select_NivelVisualizacinenReclasificacion'), 
