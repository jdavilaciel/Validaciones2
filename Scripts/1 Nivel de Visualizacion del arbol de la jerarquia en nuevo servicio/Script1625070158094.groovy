...
WebUI.selectOptionByLabel(findTestObject('Configuracion/Distribucion Geografica/Grupos/Edicion/select_NivelVisualizacionenNuevoServicio'), 
    'Todos', false)
...
WebUI.selectOptionByIndex(findTestObject('Configuracion/Distribucion Geografica/Grupos/Edicion/select_NivelVisualizacionenNuevoServicio'), 
