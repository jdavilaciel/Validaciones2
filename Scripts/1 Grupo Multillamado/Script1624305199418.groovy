...
WebUI.click(findTestObject('Configuracion/Distribucion Geografica/Grupos/Edicion/input_Multillamado'))
...
WebUI.click(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Grupos de Terminales Multillamado/a_Abrir'))
