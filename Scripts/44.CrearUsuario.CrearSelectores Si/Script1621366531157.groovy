...
'CrearUsuario.CrearSelectores'
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'CrearUsuario.CrearSelectores')
...
WebUI.setText(findTestObject('Configuracion/Seguridad/Usuarios/Agregar Usuarios/1Informacion Principal/input_Correo'), 'juan2@gmail.com')
