...
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'Terminal.RegistrarIpAlAbrir')
...
WebUI.navigateToUrl(GlobalVariable.UrlTerminales)

WebUI.delay(3)

WebUI.click(findTestObject('Configuracion/Elementos del Sistema/Terminales/2Lista Terminales/Oficinas/a_Seleccionar'))
