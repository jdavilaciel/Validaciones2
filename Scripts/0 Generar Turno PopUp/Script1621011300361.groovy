...
WebUI.setText(findTestObject('2 Operacion/Elementos del Sistema/Selectores/2 Escoger por jerarquia/input_Buscar por jerarquia'), 
    'info')
...
WebUI.click(findTestObject('2 Operacion/Elementos del Sistema/Selectores/1 Datos basicos de selector/img_Cerrar selector'))

WebUI.delay(3)

WebUI.click(findTestObject('2 Operacion/Elementos del Sistema/Selectores/1 Datos basicos de selector/Motivos para cerrar selector/btn_FindeJornada'))
