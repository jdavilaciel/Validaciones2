...
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'Usuarios.Contrasena.ExpRegular')
...
WebUI.click(findTestObject('0Inicio Sesion/Menu Tres Rayas/nuevos/a_Cambiar Clave'))

WebUI.delay(2)

WebUI.setText(findTestObject('0Inicio Sesion/Menu Tres Rayas/CambiarClave/input_ContrasenaActual'), 'digiturno')

WebUI.setText(findTestObject('0Inicio Sesion/Menu Tres Rayas/CambiarClave/input_NuevaContrasena'), 'digi')

WebUI.setText(findTestObject('0Inicio Sesion/Menu Tres Rayas/CambiarClave/input_ConfirmarContrasenaNueva'), 'digi')

WebUI.click(findTestObject('0Inicio Sesion/Menu Tres Rayas/CambiarClave/img_CambiarContrasena'))
