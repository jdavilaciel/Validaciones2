...
'UsuarioCliente.CrearOActualizarAutomaticamente'
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'UsuarioCliente.CrearOActualizarAutomaticamente')
...
WebUI.click(findTestObject('2 Operacion/Elementos del Sistema/Terminales/Terminal/Cliente/botones/img_Buscar'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

'Se cambia el segundo apellido para verificar posteriormente'
