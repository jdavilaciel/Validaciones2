...
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'Sistema.Terminal.TipoDeControlBuscar')
...
WebUI.sendKeys(findTestObject(null), 'Basico')
