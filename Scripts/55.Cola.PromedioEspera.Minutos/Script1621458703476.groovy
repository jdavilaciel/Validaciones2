...
'Cola.PromedioEspera.Minutos'
WebUI.setText(findTestObject('Configuracion/Sistema/Parametros Generales/Filtro 1er valor/input_Texto a buscar1'), 'Cola.PromedioEspera.Minutos')
